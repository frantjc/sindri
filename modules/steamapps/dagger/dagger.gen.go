...
// The `SindriID` scalar type represents an identifier for an object of type Sindri.
...
func (r *Client) LoadSindriFromID(id SindriID) *Sindri {
	q := r.query.Select("loadSindriFromID")
	q = q.Arg("id", id)
...
func (r *Client) Steamcmd() *Steamcmd { // steamcmd (../../modules/steamapps/steamcmd/main.go:19:6)
...
func (r *Sindri) ID(ctx context.Context) (SindriID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response SindriID
...
type Steamcmd struct { // steamcmd (../../modules/steamapps/steamcmd/main.go:19:6)
	query *querybuilder.Selection
...
func (r *Steamcmd) AppInfoPrint(ctx context.Context, appId int) (string, error) { // steamcmd (../../modules/steamapps/steamcmd/main.go:26:1)
...
type SteamcmdAppUpdateOpts struct {
	...
	// Default: "public"
	Branch string // steamcmd (../../modules/steamapps/steamcmd/main.go:74:2)

	BetaPassword string // steamcmd (../../modules/steamapps/steamcmd/main.go:76:2)

	// Default: "linux"
	PlatformType string // steamcmd (../../modules/steamapps/steamcmd/main.go:79:2)
}

func (r *Steamcmd) AppUpdate(appId int, opts ...SteamcmdAppUpdateOpts) *Directory { // steamcmd (../../modules/steamapps/steamcmd/main.go:69:1)
...
func (r *Steamcmd) Container() *Container { // steamcmd (../../modules/steamapps/steamcmd/main.go:21:1)
	q := r.query.Select("container")
...
func serveModuleDependencies(ctx context.Context, client *Client) error {
	modSrc := client.ModuleSource(".", ModuleSourceOpts{
		DisableFindUp: false,
	})
