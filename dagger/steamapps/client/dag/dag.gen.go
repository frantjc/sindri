...
import (
	...
	dagger "dagger/steamapps/client"
...
func LoadSteamappsFromID(id dagger.SteamappsID) *dagger.Steamapps {
	client := initClient()
	return client.LoadSteamappsFromID(id)
}
...
func Steamapps() *dagger.Steamapps {
	client := initClient()
	return client.Steamapps()
}
