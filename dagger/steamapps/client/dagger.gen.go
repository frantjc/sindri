...
// The `SteamappsID` scalar type represents an identifier for an object of type Steamapps.
type SteamappsID string
...
type Abioticfactor struct { // abioticfactor (../../dagger/steamapps/modules/abioticfactor/main.go:17:6)
...
type AbioticfactorContainerOpts struct {
	...
	// Default: "public"
	Branch string // abioticfactor (../../dagger/steamapps/modules/abioticfactor/main.go:32:2)
}

func (r *Abioticfactor) Container(opts ...AbioticfactorContainerOpts) *Container { // abioticfactor (../../dagger/steamapps/modules/abioticfactor/main.go:28:1)
...
type Astroneer struct { // astroneer (../../dagger/steamapps/modules/astroneer/main.go:17:6)
	query *querybuilder.Selection
...
type AstroneerContainerOpts struct {
	...
	// Default: "public"
	Branch string // astroneer (../../dagger/steamapps/modules/astroneer/main.go:32:2)
}

func (r *Astroneer) Container(opts ...AstroneerContainerOpts) *Container { // astroneer (../../dagger/steamapps/modules/astroneer/main.go:28:1)
	q := r.query.Select("container")
	for i := len(opts) - 1; i >= 0; i-- {
		// `branch` optional argument
		if !querybuilder.IsZeroValue(opts[i].Branch) {
...
// Retrieve the binding value, as type Steamapps
func (r *Binding) AsSteamapps() *Steamapps {
	q := r.query.Select("asSteamapps")
...
type Corekeeper struct { // corekeeper (../../dagger/steamapps/modules/corekeeper/main.go:17:6)
	query *querybuilder.Selection
...
type CorekeeperContainerOpts struct {
	...
	// Default: "public"
	Branch string // corekeeper (../../dagger/steamapps/modules/corekeeper/main.go:32:2)
}

func (r *Corekeeper) Container(opts ...CorekeeperContainerOpts) *Container { // corekeeper (../../dagger/steamapps/modules/corekeeper/main.go:28:1)
	q := r.query.Select("container")
	for i := len(opts) - 1; i >= 0; i-- {
		// `branch` optional argument
		if !querybuilder.IsZeroValue(opts[i].Branch) {
...
type Enshrouded struct { // enshrouded (../../dagger/steamapps/modules/enshrouded/main.go:17:6)
	query *querybuilder.Selection
...
type EnshroudedContainerOpts struct {
	...
	// Default: "public"
	Branch string // enshrouded (../../dagger/steamapps/modules/enshrouded/main.go:32:2)
}

func (r *Enshrouded) Container(opts ...EnshroudedContainerOpts) *Container { // enshrouded (../../dagger/steamapps/modules/enshrouded/main.go:28:1)
	q := r.query.Select("container")
	for i := len(opts) - 1; i >= 0; i-- {
		// `branch` optional argument
		if !querybuilder.IsZeroValue(opts[i].Branch) {
...
// Create or update a binding of type Steamapps in the environment
func (r *Env) WithSteamappsInput(name string, value *Steamapps, description string) *Env {
	assertNotNil("value", value)
	q := r.query.Select("withSteamappsInput")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
	q = q.Arg("description", description)
...
// Declare a desired Steamapps output to be assigned in the environment
func (r *Env) WithSteamappsOutput(name string, description string) *Env {
	q := r.query.Select("withSteamappsOutput")
	q = q.Arg("name", name)
	q = q.Arg("description", description)
...
type Palworld struct { // palworld (../../dagger/steamapps/modules/palworld/main.go:17:6)
	query *querybuilder.Selection
...
type PalworldContainerOpts struct {
	...
	// Default: "public"
	Branch string // palworld (../../dagger/steamapps/modules/palworld/main.go:32:2)
}

func (r *Palworld) Container(opts ...PalworldContainerOpts) *Container { // palworld (../../dagger/steamapps/modules/palworld/main.go:28:1)
	q := r.query.Select("container")
	for i := len(opts) - 1; i >= 0; i-- {
		// `branch` optional argument
		if !querybuilder.IsZeroValue(opts[i].Branch) {
...
func (r *Client) Abioticfactor() *Abioticfactor { // abioticfactor (../../dagger/steamapps/modules/abioticfactor/main.go:17:6)
...
func (r *Client) Astroneer() *Astroneer { // astroneer (../../dagger/steamapps/modules/astroneer/main.go:17:6)
...
func (r *Client) Corekeeper() *Corekeeper { // corekeeper (../../dagger/steamapps/modules/corekeeper/main.go:17:6)
...
func (r *Client) Enshrouded() *Enshrouded { // enshrouded (../../dagger/steamapps/modules/enshrouded/main.go:17:6)
...
// Load a Steamapps from its ID.
func (r *Client) LoadSteamappsFromID(id SteamappsID) *Steamapps {
	q := r.query.Select("loadSteamappsFromID")
	q = q.Arg("id", id)
...
func (r *Client) Palworld() *Palworld { // palworld (../../dagger/steamapps/modules/palworld/main.go:17:6)
...
func (r *Client) Satisfactory() *Satisfactory { // satisfactory (../../dagger/steamapps/modules/satisfactory/main.go:17:6)
...
func (r *Client) Steamapps() *Steamapps { // steamapps (../../dagger/steamapps/main.go:9:6)
	q := r.query.Select("steamapps")
...
func (r *Client) Valheim() *Valheim { // valheim (../../dagger/steamapps/modules/valheim/main.go:17:6)
...
type Satisfactory struct { // satisfactory (../../dagger/steamapps/modules/satisfactory/main.go:17:6)
	query *querybuilder.Selection
...
type SatisfactoryContainerOpts struct {
	...
	// Default: "public"
	Branch string // satisfactory (../../dagger/steamapps/modules/satisfactory/main.go:32:2)
}

func (r *Satisfactory) Container(opts ...SatisfactoryContainerOpts) *Container { // satisfactory (../../dagger/steamapps/modules/satisfactory/main.go:28:1)
	q := r.query.Select("container")
	for i := len(opts) - 1; i >= 0; i-- {
		// `branch` optional argument
		if !querybuilder.IsZeroValue(opts[i].Branch) {
...
type Steamapps struct { // steamapps (../../dagger/steamapps/main.go:9:6)
	query *querybuilder.Selection

	id *SteamappsID
}

func (r *Steamapps) WithGraphQLQuery(q *querybuilder.Selection) *Steamapps {
	return &Steamapps{
		query: q,
	}
}

func (r *Steamapps) Container(name string, reference string) *Container { // steamapps (../../dagger/steamapps/main.go:11:1)
	q := r.query.Select("container")
	q = q.Arg("name", name)
...
// A unique identifier for this Steamapps.
func (r *Steamapps) ID(ctx context.Context) (SteamappsID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response SteamappsID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Steamapps) XXX_GraphQLType() string {
	return "Steamapps"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Steamapps) XXX_GraphQLIDType() string {
	return "SteamappsID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Steamapps) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Steamapps) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
type Valheim struct { // valheim (../../dagger/steamapps/modules/valheim/main.go:17:6)
	query *querybuilder.Selection
...
type ValheimContainerOpts struct {
	...
	// Default: "public"
	Branch string // valheim (../../dagger/steamapps/modules/valheim/main.go:32:2)
}

func (r *Valheim) Container(opts ...ValheimContainerOpts) *Container { // valheim (../../dagger/steamapps/modules/valheim/main.go:28:1)
	q := r.query.Select("container")
	for i := len(opts) - 1; i >= 0; i-- {
		// `branch` optional argument
		if !querybuilder.IsZeroValue(opts[i].Branch) {
