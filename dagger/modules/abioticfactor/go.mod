module github.com/frantjc/sindri/dagger/modules/abioticfactor
...
require (
	...
	github.com/frantjc/go-encoding-vdf v0.0.0-20250908051448-2630761f0d09
	github.com/frantjc/x v0.0.0-20250905020910-8e4568f4eb1d // indirect
